		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Modelos SAPUI5",
									"targetURL": "#treinaui5modelosui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"treinaui5modelosui5-display": {
								"semanticObject": "treinaui5modelosui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=treinaui5.modelosui5",
									"url": sap.ui.require.toUrl("treinaui5/modelosui5")
								}
							}
						}
					}
